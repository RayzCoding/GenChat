...
import { stopAgent, streamPpt } from '../services/agentApi'
...
export function usePptStream({ conversationId, onSessionUpdated }: UsePptStreamOptions) {
  ...
  const sendMessage = useCallback(
    async (question: string, t: (key: string) => string) => {
      ...
      try {
        await streamPpt(conversationId, trimmed, controller.signal, (line) => {
